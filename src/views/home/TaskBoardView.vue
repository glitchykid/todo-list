...
<template>
  ...
  <Transition name="sheet-left">
    <aside
      v-if="toggleAside"
      class="fixed inset-y-0 left-0 z-[100] flex h-full w-[min(19rem,68vw)] flex-col overflow-y-auto border-r border-[var(--color-border)] bg-[var(--color-surface-raised)] px-3 py-5 shadow-[var(--shadow-panel)] md:hidden"
    >
      <WorkspacePanel />
    </aside>
  </Transition>
