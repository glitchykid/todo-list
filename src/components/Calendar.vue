...
const currentMonth: string = new Intl.DateTimeFormat("default", {
  month: "long",
}).format(date);
const currentYear: string = new Intl.DateTimeFormat("default", {
  year: "numeric",
}).format(date);
...
<template>
  <div
    class="border-1 border-[#C9D7ED] flex flex-col absolute -right-1/2 bg-white mt-4 text-[#8276FF] rounded-[8px] p-4 gap-4"
  >
